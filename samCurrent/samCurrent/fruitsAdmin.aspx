<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="fruitsAdmin.aspx.cs" Inherits="fruitsAdmin" %>
...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Setup Fruits</h1>
            </div>
...
<td>
<asp:TextBox ID="txtnut" TextMode="MultiLine" runat="server"></asp:TextBox>
</td>
</tr>
...
<asp:GridView runat="server" ID="gvImage" 
        ...
        OnRowCancelingEdit="gvImage_RowCancelingEdit" DataKeyNames="fruit_id" 
...
<%--<asp:BoundField HeaderText = "Fruit Name" DataField="fruit_name" />--%>
   ...
   <asp:TemplateField HeaderText="Fruit Name" HeaderStyle-Width="200px">  
                        ...
                        <EditItemTemplate>  
                            <asp:TextBox ID="txt_Name" runat="server" Text='<%# Eval("fruit_name") %>'></asp:TextBox>  
                        </EditItemTemplate>  
                    </asp:TemplateField>  
                     ...
                     <asp:TemplateField HeaderText="Nutritional Facts" HeaderStyle-Width="200px">  
                        ...
                        <EditItemTemplate>  
                            <asp:TextBox ID="txt_nuti" runat="server" TextMode="MultiLine" Text='<%# Eval("nutritional_facts") %>'></asp:TextBox>  
                        </EditItemTemplate>  
                    </asp:TemplateField>  
