<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="viewAdminFruit.aspx.cs" Inherits="viewAdminFruit" %>
...
<%--<asp:BoundField HeaderText = "Fruit Name" DataField="fruit_name" />--%>
   ...
   <asp:TemplateField HeaderText="Fruit Name" HeaderStyle-Width="200px">  
                      ...
                      <asp:TemplateField HeaderText="Nutritional Facts" HeaderStyle-Width="200px">  
                        ...
                        <EditItemTemplate>  
                            <asp:TextBox ID="txt_nuti" runat="server" Text='<%# Eval("nutritional_facts") %>'></asp:TextBox>  
                        </EditItemTemplate>  
                    </asp:TemplateField>  
