<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CholestrolReciepe.aspx.cs" Inherits="CholestrolReciepe" %>
...
<div class="header">
  <h1 class="w3-center">CHOLESTROL</h1>
...
--%>  <div class="tab-content col-12 " style=" margin:150px; ">
  ...
  <div class="w3-row w3-padding-64" id="Div7">
    <div class="w3-col m6 w3-padding-large w3-hide-small">
     <img src="Assets/healthytips/images/cholestrol_breakfast_1.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="600" height="950">
    </div>
    ...
    <div class="w3-col m6 w3-padding-large">
      ...
      <h3 style=" color:#65B998;"class="w3-center">Stuffed French Toast</h3>
 ...
 <p style="margin:15px;"class="w3-small">1. Combine sour cream and maple syrup in a small bowl; stir with a whisk.<br>2. Combine berries, and spoon into dessert dishes; pour maple cream over berries.
  ...
  <div class="w3-row w3-padding-64" id="Div8">
    <div class="w3-col l6 w3-padding-large">
      ...
      <h3 style=" color:#FF808C;"class="w3-center">SALMON SALAD WITH BEANS</h3>
...
<br>2.	Repeat procedure for remaining 3 wraps.
    ...
    <div class="w3-col l6 w3-padding-large">
      <img src="Assets/healthytips/images/cholestrol_lunch_1.jpg" class="w3-round w3-image w3-opacity-min" alt="Menu" width="500" height="750">
    </div>
  </div>
  

     <div class="w3-col m6 w3-padding-large w3-hide-small">
     <img src="Assets/healthytips/images/cholestrol_dinner_1.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="600" height="950">
    </div>
    ...
    <div class="w3-col m6 w3-padding-large">
      ...
      <h3 style=" color:#FFBC6E;"class="w3-center">Cuban-Marinated Sirloin Kabobs with Grilled Asparagus</h3>
