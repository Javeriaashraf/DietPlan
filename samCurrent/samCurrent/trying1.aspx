<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="trying1.aspx.cs" Inherits="trying1" %>
...
<div class="header">
  <h1 class="w3-center">DIABETES TYPE 1</h1>
...
--%>  <div class="tab-content col-12 " style=" margin:150px; ">
  ...
  <div class="w3-row w3-padding-64" id="Div7">
    <div class="w3-col m6 w3-padding-large w3-hide-small">
     <img src="Assets/healthytips/images/dia1_Breakfast_1.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="600" height="950">
    </div>
    ...
    <div class="w3-col m6 w3-padding-large">
      ...
      <h3 style=" color:#65B998;"class="w3-center">	Fresh Berries with Maple Cream</h3>
...
<br>2.	Repeat procedure for remaining 3 wraps.
    ...
    <div class="w3-col l6 w3-padding-large">
      <img src="Assets/healthytips/images/dia1_Lunch_11.jpg" class="w3-round w3-image w3-opacity-min" alt="Menu" width="500" height="750">
    </div>
  </div>
  

     <div class="w3-col m6 w3-padding-large w3-hide-small">
     <img src="Assets/healthytips/images/dia1_Dinner_1.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="600" height="950">
    </div>
