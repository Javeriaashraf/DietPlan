<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GeneralReciepe.aspx.cs" Inherits="GeneralReciepe" %>
...
<div class="header">
  <h1 class="w3-center">Weight Loss</h1>
...
--%>  <div class="tab-content col-12 " style=" margin:150px; ">
  ...
  <!-- About Section -->
    ...
    <div class="w3-col m6 w3-padding-large w3-hide-small">
     <img src="Assets/healthytips/images/gen_breakfast_1.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="600" height="950">
    </div>
    ...
    <div class="w3-col m6 w3-padding-large">
      ...
      <h3 style=" color:#65B998;"class="w3-center">Cantaloupe Slush with Mango</h3>
          <a onclick="myFunction('Demo1')" style="  background-color:#7FE8BF;"class="w3-margin-top w3-btn w3-block  w3-left-align">Nutritional Information</a>
            <div id="Demo1" class="w3-container w3-hide">
                <p class="w3-small">Calories: 100
<br>Protein: 2 g
<br>Carbs: 24 g
<br>Fat: 1 g
<br>Saturated Fat: 0 g
<br>Sodium: 15 mg
<br>Fiber: 2 g
</p>            </div>
    
     <p style="  background-color:#7FE8BF; padding:10px;"class="w3-margin-top  w3-block  w3-left-align">Ingredients</p>
 <p style="margin:15px;"class="w3-small">1 medium sized cantaloupe
...
<p style="  background-color:#7FE8BF; padding:10px;"class="w3-margin-top  w3-block  w3-left-align">Preparation</p>
 <p style="margin:15px;"class="w3-small">1 	Peel and seed cantaloupe. Cut into 1-inch pieces. (It should equal about 6 cups.) Place in blender or food processor with lemon juice and honey, and puree until very smooth.
<br>2 	Pour mixture into a shallow "9x12" glass pan and set in the freezer for two hours.
<br>3 	With a fork, chip and stir the icy mixture and return it to the freezer for two to four hours.
<br>4 	Peel and cut mango into long, thin, attractive slices, avoiding the pit.
<br>5 	Again with a fork, chip the frozen cantaloupe mixture so it resembles a snow cone or shaved ice. Spoon it into clear bowls, top with mango slices, and serve.
<br>6 	ENJOY!
</p>   
   </div>
...
<br>2.	Repeat procedure for remaining 3 wraps.
    ...
    <div class="w3-col l6 w3-padding-large">
      <img src="Assets/healthytips/images/gen_lunch_1.jpg" class="w3-round w3-image w3-opacity-min" alt="Menu" width="500" height="750">
    </div>
  </div>
  

     <div class="w3-col m6 w3-padding-large w3-hide-small">
     <img src="Assets/healthytips/images/gen_dinner_1.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="600" height="950">
    </div>
